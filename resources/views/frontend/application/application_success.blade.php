...
<div class="container">
    ...
    <div class="right">
        ...
        <table>
            <tr>
                <td>
                    <h3><u> শিক্ষা প্রতিষ্ঠান প্রধানের সুপারিশ স্বাক্ষর </u> </h3>
                    <h3> আমি এই মর্মে প্রত্যয়ন করছি যে, উপরে বর্ণিত শিক্ষার্থীর তথ্য সঠিক। আমি তাকে শিক্ষা প্রতিষ্ঠানে ভর্তির জন্য আর্থিক সহায়তা প্রদানের জন্য সুপারিশ করছি। </h3>
                </td>
                <td>
                    <h3> স্বাক্ষর: </h3>
                </td>
